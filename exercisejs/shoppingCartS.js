window.onload = function(){
    ...
    var tr = cartTable.children[1].rows;  //table标签特有的属性，rows可以获得表格元素的所有tr行。children只返回元素节点
    ...
    function getTotle(){
        ...
        priceTotle.innerHTML = priceNum.toFixed(2);//toFfixed(paras),paras指保留几位小数，该方法用于把数字转化为string，并四舍五入小数位。
